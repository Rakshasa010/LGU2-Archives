(function () {
    var LANDING_I18N = {
        ...
        feat5_t: { en: "Reports & Analytics", tl: "Mga Ulat at Analytics" },
        feat5_d: { en: "Dashboard insights on archived records, activity, and storage usage.", tl: "Mga insight sa dashboard tungkol sa mga rekord, aktibidad, at paggamit ng storage." },
        feat6_t: { en: "User & Role Management", tl: "Pamamahala ng Gumagamit at Tungkulin" },
        feat6_d: { en: "Admins control access with roles, approvals, and complete audit trails.", tl: "Kinokontrol ng mga admin ang pag-access sa pamamagitan ng mga tungkulin, pag-apruba, at kumpletong talaan ng pag-audit." },
