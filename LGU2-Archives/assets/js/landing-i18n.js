(function () {
    var LANDING_I18N = {
        ...
        feat5_t: { en: "Google Auth", tl: "Pag-login gamit ang Google" },
        feat5_d: { en: "One-click sign in and registration with your Google account via secure OAuth 2.0.", tl: "Isang click na pag-sign in at pagparehistro gamit ang iyong Google account sa pamamagitan ng ligtas na OAuth 2.0." },
        feat6_t: { en: "IPFS Pinata", tl: "IPFS Pinata" },
        feat6_d: { en: "Documents pinned to IPFS via Pinata for tamper-proof, decentralized storage.", tl: "Mga dokumentong naka-pin sa IPFS sa pamamagitan ng Pinata para sa ligtas at desentralisadong imbakan." },
