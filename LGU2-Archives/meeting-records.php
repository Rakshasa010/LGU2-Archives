...
<body class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800 text-gray-900 dark:text-gray-100 transition-colors duration-200">
    ...
    <script>
        ...
        function confirmDelete() {
            if (isServerDelete) {
                // Server-side record deletion logic
                ...
                // Client-side sample file deletion logic
                if (deleteTargetIndex === null) return;
                
                const file = files[deleteTargetIndex];
                const fileType = file.type.toUpperCase();

                window.DeletedFiles?.add({
                    id: `meeting_${Date.now()}_${deleteTargetIndex}`,
                ...
                files.splice(deleteTargetIndex, 1);
                renderFiles();
            }
        ...
        /* 
        // Disabled auto-rendering of sample data to prevent overwriting server data
