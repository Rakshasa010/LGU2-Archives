...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-2xl bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8">        
        ...
        <div id="sso-error-banner" class="hidden mb-6 p-4 bg-red-100 dark:bg-red-900/30 border-2 border-red-400 dark:border-red-700/60 text-red-700 dark:text-red-300 rounded-xl font-semibold"></div>
        ...
        <div class="relative my-6">
            ...
            <div class="relative flex justify-center">
                <span class="px-3 text-xs font-semibold text-gray-600 dark:text-gray-400 bg-white dark:bg-slate-800">Or continue with</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-3">
            <a href="#" id="btn-google-sso" class="js-google-sso-btn relative flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-200 hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-red-500 transition-all duration-200 font-semibold overflow-hidden group">
                ...
                <span class="text-sm relative z-10">Sign in with Google</span>
