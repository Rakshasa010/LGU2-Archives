...
$sql = "SELECT id, title, type, month, year, author, created_at, last_accessed FROM legislative_records WHERE type = 'Billing' ORDER BY year DESC, month DESC, created_at DESC";
...
<body class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800 text-gray-900 dark:text-gray-100 transition-colors duration-200">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 pb-6 border-b border-gray-200 dark:border-slate-700">
            ...
            <p class="text-gray-600 dark:text-gray-400">Manage and view billing documents</p>
        </div>
            ...
            <div id="filesList" class="space-y-4">
                <?php if (empty($billing_records)): ?>
                    <div class="text-center py-12">
                        ...
                        <div class="text-gray-600 dark:text-gray-400">Billing documents will appear here once uploaded</div>
                    </div>
                <?php else: ?>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-400">
                                        <span class="px-2 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300 rounded"><?php echo htmlspecialchars($record['type']); ?></span>
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-md w-full p-6 border border-gray-200 dark:border-slate-700">
                ...
                <form id="uploadForm" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="fileName" placeholder="e.g., 2024-01-15_Billing_Statement.pdf" required
                               class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-red-500 focus:border-transparent">
                    </div>
