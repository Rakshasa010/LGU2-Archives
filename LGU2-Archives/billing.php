...
// Fetch Files
$files = [];
$file_sql = "SELECT id, title, type, month, year, author, created_at, last_accessed, parent_version_id FROM legislative_records WHERE type = 'Billing' AND parent_version_id IS NULL";
if ($current_folder_id) {
...
try {
    ...
    $file_res = false;
    error_log("SQL Error in billing: " . $e->getMessage());
}
if ($file_res) {
