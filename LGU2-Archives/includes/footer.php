...
<footer style="background-color: #0f172a; color: white; padding: 3rem 2rem; margin-top: 2rem;">
    <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
        ...
        <div>
            <h3 style="font-weight: bold; font-size: 1.125rem; margin-bottom: 1rem;">Quick Links</h3>
            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                <li><a href="#" style="color: #94a3b8; text-decoration: none;">Legislative Archives</a></li>
                <li><a href="#" style="color: #94a3b8; text-decoration: none;">Session Calendars</a></li>
                <li><a href="#" style="color: #94a3b8; text-decoration: none;">Public Consultations</a></li>
                <li><a href="#" style="color: #94a3b8; text-decoration: none;">Committee Reports</a></li>
            </ul>
        </div>

        <!-- Column 3: Contact Us -->
        <div>
            <h3 style="font-weight: bold; font-size: 1.125rem; margin-bottom: 1rem;">Contact Us</h3>
            <div style="display: flex; align-items: flex-start; gap: 0.75rem; margin-bottom: 0.75rem; color: #94a3b8;">
                <i class="bi bi-geo-alt" style="color: #ef4444; margin-top: 2px;"></i>
                <span>Valenzuela City Hall, MacArthur Highway, Valenzuela</span>
            </div>
            <div style="display: flex; align-items: center; gap: 0.75rem; color: #94a3b8;">
                <i class="bi bi-telephone" style="color: #ef4444;"></i>
                <span>(02) 8352-1000</span>
            </div>
        </div>
    </div>

    <!-- Bottom Bar -->
    <div style="max-width: 1200px; margin: 2.5rem auto 0; padding-top: 1.5rem; border-top: 1px solid rgba(255,255,255,0.1); display: flex; justify-content: space-between; align-items: center;">
        <p style="color: #94a3b8; font-size: 0.875rem; margin: 0;">
            &copy; 2026 SPVALENZUELA. All rights reserved.
        </p>
        <div style="display: flex; gap: 1.5rem;">
            <a href="#" style="color: #94a3b8; text-decoration: none; font-size: 0.875rem;">Privacy Policy</a>
            <a href="#" style="color: #94a3b8; text-decoration: none; font-size: 0.875rem;">Terms of Service</a>
        </div>
    </div>
</footer>
