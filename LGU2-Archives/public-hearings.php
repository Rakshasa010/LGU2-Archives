                ...
                <?php else: ?>
                    <?php foreach ($files as $record): ?>
                        <div data-id="<?php echo $record['id']; ?>" 
                            ...
                            <div class="flex-shrink-0">
                                <i class="bi bi-file-earmark-text text-green-600 dark:text-green-400 text-2xl"></i>
                            </div>

                            <div class="flex-1 min-w-0">
                                <div class="font-medium text-gray-800 dark:text-gray-200 truncate"><?php echo htmlspecialchars($record['title']); ?></div>
                                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1 truncate">
                                    <span class="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded text-[11px]"><?php echo htmlspecialchars($record['type']); ?></span>
                                    <span class="mx-2">•</span>
